...
export const ContactDetails = () => {
    return <section className="min-h-screen bg-zinc-800">
        <div className="py-8 lg:py-16 px-4 mx-auto max-w-screen-md">
            ...
            <form action="#" className="space-y-8">
                ...
                <button type="submit" className="py-3 px-5 text-sm font-medium text-center text-white rounded-lg bg-primary-700 sm:w-fit hover:bg-primary-800 focus:ring-4 focus:outline-none bg-blue-600">Send message</button>
            </form>
        </div>
    </section>
}
